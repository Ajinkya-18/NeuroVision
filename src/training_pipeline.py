...
if __name__ == "__main__":
    ...
    root_dir = Path('../NeuroVision/data/Class_Combined_Balanced_Dataset')
    ...
    lstm_model = EegLstm(input_dims=5, hidden_dims=128, num_layers=2, dropout=0.3, num_classes=len(os.listdir(root_dir)))
